...
class LanguageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $languages = [
            ...
            ['code' => 'de', 'name' => 'German', 'translated_text' => 'Deutsch', 'active' => false],
            ['code' => 'es', 'name' => 'Spanish', 'translated_text' => 'Español', 'active' => false],
            ['code' => 'fa', 'name' => 'Persian', 'translated_text' => 'فارسی', 'active' => false],
            ['code' => 'fr', 'name' => 'French', 'translated_text' => 'Français', 'active' => false],
            ...
            ['code' => 'vi', 'name' => 'Vietnamese', 'translated_text' => 'Tiếng Việt', 'active' => true],
