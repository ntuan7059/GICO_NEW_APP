...
class MenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $menuItems = [
            ...
            ['slug' => 'product', 'order_number' => 3, 'parent_id' => null],
            ['slug' => 'document', 'order_number' => 4, 'parent_id' => null],
        ...
        $defaultTitles = ['Home', 'About Us', 'Product', 'Document', 'Contact Us'];

        $localizedSamples = [
            'fr' => ['Accueil', 'À propos', 'Produit', 'Document', 'Contact'],
            'es' => ['Inicio', 'Sobre nosotros', 'Producto', 'Documento', 'Contacto'],
        ];
