<footer class="site-footer">
    <div class="container footer-grid">
        ...
        <div><h2>Hỗ trợ dự án</h2><ul>
            <li><button class="footer-link-button js-open-inquiry">Yêu cầu báo giá</button></li><li><a href="mailto:gicovn186@gmail.com">Gửi yêu cầu qua email</a></li><li><a href="tel:0906236863">Tư vấn kỹ thuật</a></li><li><a href="{{ route('contact') }}">Thông tin liên hệ</a></li>
        </ul></div>
        <div class="footer-contact"><h2>Liên hệ</h2>
            ...
            <p><i class="fa-regular fa-envelope"></i><a href="mailto:gicovn186@gmail.com">gicovn186@gmail.com</a></p>
